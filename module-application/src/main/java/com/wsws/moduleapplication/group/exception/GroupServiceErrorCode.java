...
public enum GroupServiceErrorCode implements BaseErrorCode {
    GROUP_NOT_FOUND(NOT_FOUND, "GROUP_400_1", "그룹을 찾을 수 없습니다."),
    MEMBER_NOT_FOUND(BAD_REQUEST, "GROUP_400_2", "존재하지 않는 멤버입니다."),
    UNAUTHORIZED_ACCESS(BAD_REQUEST, "GROUP_400_3","권한이 없습니다. 관리자만 수정할 수 있습니다."),
    MEMBER_NOT_IN_GROUP(BAD_REQUEST, "GROUP_400_4","이 그룹에 속하지 않은 멤버입니다."),
    ALREADY_IN_GROUP(BAD_REQUEST, "GROUP_400_5", "이미 그룹에 가입되어 있습니다.");
