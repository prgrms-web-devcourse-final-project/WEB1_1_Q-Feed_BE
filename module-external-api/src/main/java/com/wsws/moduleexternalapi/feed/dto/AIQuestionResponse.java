...
public record AIQuestionResponse(
        ...
        @JsonProperty(required = true, value = "FASHION") String fashion,
        @JsonProperty(required = true, value = "CULTURE") String culture,
        @JsonProperty(required = true, value = "SPORTS") String sports,
        @JsonProperty(required = true, value = "ETC") String etc) {
}
