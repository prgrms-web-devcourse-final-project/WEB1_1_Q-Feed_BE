...
public interface JpaGroupRepository extends JpaRepository<GroupEntity, Long> {
    ...
    //카테고리 ID로 그룹 목록 조회
    @Query("""
            SELECT new com.wsws.moduledomain.group.dto.GroupDto(
    ...
    @Query("""
            SELECT new com.wsws.moduledomain.group.dto.GroupDetailDto(
    ...
    @Query("""
            SELECT new com.wsws.moduledomain.group.dto.GroupMemberDto(
